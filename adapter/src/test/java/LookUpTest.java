...
import com.github.chevyself.babel.lookup.ReflectionLookUp;
...
public class LookUpTest {
  ...
  public static void main(String[] args) {
    ...
    ReflectionLookUp<Object, WrappedField<Object>> reflectionLookUp =
    ...
    while (versions.size() < 19 - 8) {
      ...
      String name = reflectionLookUp.getName(new Versions.BukkitVersion(version, 0));
