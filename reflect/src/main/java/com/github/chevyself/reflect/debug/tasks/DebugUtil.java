...
final class DebugUtil {
   ...
   */
  @NonNull
  public static String percentageBar(
      int size, int total, int completed, char completedChar, char uncompletedChar) {
   ...
   * Creates a percentage bar.
   *
   * <p>Uses {@code █} for completed and {@code ░} for uncompleted.
   *
